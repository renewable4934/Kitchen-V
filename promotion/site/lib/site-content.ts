...
export const fallbackSiteContent: SiteContent = {
  ...
  site: {
    ...
    contactPhone: "+79166700043",
    email: "vasiliy.kruk@yandex.com",
    address: "Россия, г. Ростов-на-Дону, Троллейбусная 16В",
    whatsappPhone: "",
      ...
      cards: [
        {
          ...
          description: "Уже совсем скоро кухня может быть Вашей. Быстрое производство без потери качества.",
          highlight: "14 дней срок поставки",
        },
        {
          icon: "shield",
          title: "Оставаться спокойным — дольше",
          description: "Полная гарантия на все материалы и работу. Мы уверены в каждом изделии.",
          highlight: "Гарантия 5 лет на всё",
        },
        {
          icon: "wrench",
          title: "Делегировать под ключ — надежнее",
          description: "Подберём и установим всю встраиваемую бытовую технику.",
          highlight: "1 подрядчик по всем вопросам",
        },
        {
          icon: "banknote",
          title: "Покупать — выгоднее",
          description: "Прозрачное ценообразование без скрытых платежей.",
          highlight: "70 000 ₽ / пог. метр",
        },
      ],
    },
    lifestyle: {
