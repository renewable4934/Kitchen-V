          ...
          options: [
            {
              value: "neoklassika",
              label: "Неоклассика",
              imageKey: "/images/configurator/styles-webp/neoklassika.webp",
            },
            {
              value: "minimalizm",
              label: "Минимализм",
              imageKey: "/images/configurator/styles-webp/minimalizm.webp",
            },
            {
              value: "skandi-dzen",
              label: "Сканди-дзен",
              imageKey: "/images/configurator/styles-webp/skandi-dzen.webp",
            },
            {
              value: "klassika",
              label: "Классика",
              imageKey: "/images/configurator/styles-webp/klassika.webp",
            },
            {
              value: "eko",
              label: "Эко",
              imageKey: "/images/configurator/styles-webp/eko.webp",
            },
            {
              value: "loft",
              label: "Лофт",
              imageKey: "/images/configurator/styles-webp/loft.webp",
            },
            {
              value: "kantri",
              label: "Кантри",
              imageKey: "/images/configurator/styles-webp/kantri.webp",
            },
            {
              value: "sredizemnomore",
              label: "Средиземноморье",
              imageKey: "/images/configurator/styles-webp/sredizemnomore.webp",
            },
          ],
        },
        {
    ...
    contract: {
      ...
      cards: [
        ...
        },
        {
          ...
          description: "Полная гарантия на фасады, фурнитуру и механизмы. Быстрая замена в случае поломки.",
          highlight: "",
        },
        {
          icon: "wrench",
